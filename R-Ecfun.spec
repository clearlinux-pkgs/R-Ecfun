...
Version  : 0.3.0
Release  : 55
URL      : https://cran.r-project.org/src/contrib/Ecfun_0.3-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Ecfun_0.3-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658500718
