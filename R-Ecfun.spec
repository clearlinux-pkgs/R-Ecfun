...
Version  : 0.3.6
Release  : 66
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/Ecfun_0.3-6.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/Ecfun_0.3-6.tar.gz
...
%setup -q -n Ecfun
pushd ..
cp -a Ecfun buildavx2
popd
pushd ..
cp -a Ecfun buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732306741
