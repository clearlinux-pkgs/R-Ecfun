...
Version  : 0.2.6
Release  : 53
URL      : https://cran.r-project.org/src/contrib/Ecfun_0.2-6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Ecfun_0.2-6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655314947
